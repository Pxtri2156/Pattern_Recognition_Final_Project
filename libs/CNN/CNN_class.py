...
class CNN:
    ...
    def __init__(self, cfgs):
        ...
        self.model = None
        self.input_size = cfgs.CNN.MODEL.INPUT_SIZE
        self.output_size = cfgs.CNN.MODEL.OUTPUT_SIZE
        self.epochs = cfgs.CNN.MODEL.EPOCHS
        self.batch_size = cfgs.CNN.MODEL.BATCH_SIZE
        self.define_model()
